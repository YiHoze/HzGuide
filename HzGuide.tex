...
폰트를 바꾸려면 \macro{\sbfamily} 또는 \macro{\textsb}를, 기호를 바꾸려면 \macro{\optselected}와 \macro{\optunselected}를 재정의하라.
디폴트 폰트는 \term{함초롬돋움}\annotate{HCR Dotum}이다.
...
\item[final] \keyvalue{\HideImageFilename\HidePending ...}
